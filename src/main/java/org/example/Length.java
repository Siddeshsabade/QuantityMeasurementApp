...
public class Length {
    ...
    // Factory helpers
    public static Length feet(double v) {
        return new Length(v, LengthEnum.Feet);
    }
    public static Length inches(double v) {
        return new Length(v, LengthEnum.Inches);
    }
    public static Length yards(double v) {
        return new Length(v, LengthEnum.Yards);
    }
    public static Length centimeters(double v) {
        return new Length(v, LengthEnum.Centimeters);
    }
}
