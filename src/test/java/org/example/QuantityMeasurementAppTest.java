...
public class QuantityMeasurementAppTest {
    ...
    void centimetersPrecision() {
        ...
        Length cm254 = new Length(2.54, Length.LengthUnit.Centimeters); // ≈ 1 inch
        Length oneIn = new Length(1.0, Length.LengthUnit.Inches);
    ...
    void parseNull() {
        assertNull(Length.parseUnit(null));
    }

    @Test
    @DisplayName("convert preserves sign for negative values")
    void convertNegative() {
        double v = Length.convert(-2.0, Length.LengthUnit.Feet, Length.LengthUnit.Inches);
    ...
    void convertNulls() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> Length.convert(1.0, Length.LengthUnit.Inches, null));
    }
...
//        Length len2 = new Length(1.0, Length.LengthUnit.Yards);
//
//        assertEquals(len1, len2, "Expected 1 Yards to be equal to 1 Yards");
//    }
//
//    @Test
...
//        Length len2 = new Length(3.0, Length.LengthUnit.Feet);
//
//        assertEquals(len1, len2, "Expected 1 Yards to be equal to 3 Feet");
//        assertEquals(len2, len1, "Expected symmetry: 3 Feet equals 1 Yards");
//    }
//
//    @Test
...
//        Length len2 = new Length(36.0, Length.LengthUnit.Inches);
//
//        assertEquals(len1, len2, "Expected 1 Yards to be equal to 36 Inches");
//        assertEquals(len2, len1, "Expected symmetry: 36 Inches equals 1 Yards");
//    }
//
//
//
...
//        Length len1 = new Length(1.0, Length.LengthUnit.Centimeters);
//        Length len2 = new Length(1.0, Length.LengthUnit.Centimeters);
//
//        assertEquals(len1, len2, "Expected 50 Centimeters to be equal to 50 Centimeters");
//    }
//
//
//
...
//        Length len1 = new Length(30.48, Length.LengthUnit.Centimeters);
//        Length len2 = new Length(1.0, Length.LengthUnit.Feet);
//
//        assertEquals(len1, len2, "Expected 30.48 Centimeters to be equal to 1 Feet");
//        assertEquals(len2, len1, "Expected symmetry: 1 Feet equals 30.48 Centimeters");
//    }
//
//
//
...
//        Length len2 = new Length(2.0, Length.LengthUnit.Yards);
//
//        assertNotEquals(len1, len2, "Expected 1 Yards to NOT be equal to 2 Yards");
//    }
//
//    @Test
//    public void testEquality_YardsToFeet_notEquivalentValue() {
//
//        Length len1 = new Length(1.0, Length.LengthUnit.Yards);
//        Length len2 = new Length(2.0, Length.LengthUnit.Feet);
//
//        assertNotEquals(len1, len2, "Expected 1 Yards to NOT be equal to 2 Feet");
//        assertNotEquals(len2, len1, "Expected symmetry: 2 Feet to NOT equal 1 Yards");
//    }
//
//    @Test
//    public void testEquality_YardsToInches_notEquivalentValue() {
//        Length len1 = new Length(1.0, Length.LengthUnit.Yards);
//        Length len2 = new Length(35.0, Length.LengthUnit.Inches);
//
//        assertNotEquals(len1, len2, "Expected 1 Yards to NOT be equal to 35 Inches");
//        assertNotEquals(len2, len1, "Expected symmetry: 35 Inches to NOT equal 1 Yards");
//    }
//
//    @Test
//    public void testEquality_YardsToCentimeters_notEquivalentValue() {
//        // 1 Yards = 91.44 Centimeters, so comparing with 90 Centimeters must be false
//        Length len1 = new Length(1.0, Length.LengthUnit.Yards);
//        Length len2 = new Length(90.0, Length.LengthUnit.Centimeters);
//
//        assertNotEquals(len1, len2, "Expected 1 Yards to NOT be equal to 90 Centimeters");
//        assertNotEquals(len2, len1, "Expected symmetry: 90 Centimeters to NOT equal 1 Yards");
//    }
//
//
//    @Test
...
//        Length len2 = new Length(49.0, Length.LengthUnit.Centimeters);
//
//        assertNotEquals(len1, len2, "Expected 50 Centimeters to NOT be equal to 49 Centimeters");
//    }
//
//    @Test
//    public void testEquality_CentimetersToInches_notEquivalentValue() {
//        // 2.54 Centimeters = 1 inch, so 2.0 Centimeters must NOT equal 1 inch
//        Length len1 = new Length(2.0, Length.LengthUnit.Centimeters);
//        Length len2 = new Length(1.0, Length.LengthUnit.Inches);
//
//        assertNotEquals(len1, len2, "Expected 2.0 Centimeters to NOT be equal to 1 Inch");
//        assertNotEquals(len2, len1, "Expected symmetry: 1 Inch to NOT equal 2.0 Centimeters");
//    }
//
//    @Test
//    public void testEquality_CentimetersToFeet_notEquivalentValue() {
//        // 30.48 Centimeters = 1 foot, so 30 Centimeters must NOT equal 1 foot
//        Length len1 = new Length(30.0, Length.LengthUnit.Centimeters);
//        Length len2 = new Length(1.0, Length.LengthUnit.Feet);
//
//        assertNotEquals(len1, len2, "Expected 30.0 Centimeters to NOT be equal to 1 Feet");
//        assertNotEquals(len2, len1, "Expected symmetry: 1 Feet to NOT equal 30.0 Centimeters");
//    }
//
//    @Test
//    public void testEquality_CentimetersToYards_notEquivalentValue() {
//        // 91.44 Centimeters = 1 Yards, so 92 Centimeters must NOT equal 1 Yards
//        Length len1 = new Length(92.0, Length.LengthUnit.Centimeters);
//        Length len2 = new Length(1.0, Length.LengthUnit.Yards);
//
//        assertNotEquals(len1, len2, "Expected 92.0 Centimeters to NOT be equal to 1 Yards");
//        assertNotEquals(len2, len1, "Expected symmetry: 1 Yards to NOT equal 92.0 Centimeters");
//    }
//}